...
BASE = [
    "https://www.loker.id/lowongan-kerja/information-technology/page/1",
    "https://www.loker.id/lowongan-kerja/information-technology/page/2",
    "https://www.loker.id/lowongan-kerja/information-technology/page/3",
    "https://www.loker.id/lowongan-kerja/information-technology/page/4",
    "https://www.loker.id/lowongan-kerja/information-technology/page/5",
    "https://www.loker.id/lowongan-kerja/information-technology/page/6",
    "https://www.loker.id/lowongan-kerja/information-technology/page/7",
    "https://www.loker.id/lowongan-kerja/information-technology/page/8",
]
...
df = df.replace("-", None) 
df = df.dropna(subset=["Title", "Perusahaan", "Kategori", "Lokasi", "Skills"])
df_clean = df.drop_duplicates()

clean_file = "lokerid_IT_clean.csv"
